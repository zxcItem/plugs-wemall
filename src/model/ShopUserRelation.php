 ...
 */
class ShopUserRelation extends Abs
{
    /**
     * 关联当前用户
     * @return HasOne
    ...
    {
        return $this->hasOne(ShopUserRelation::class, 'unid', 'puid0')->with('user');
    }
    ...
    {
        return $this->hasOne(ShopUserRelation::class, 'unid', 'puid1')->with('user');
    }
    ...
    {
        return $this->hasOne(ShopUserRelation::class, 'unid', 'puid2')->with('user');
    }
